...
// This script goes on any dynamic objects that wish to recieve decals
...
public class BulletExampleDynamicObjectJS extends MonoBehaviour 
{
	...
	public var m_Decals : DS_Decals;
	public var m_WorldToDecalsMatrix : Matrix4x4;

		// All the projectors that were created at runtime.
	public var m_DecalProjectors : List.<DecalProjector> = List.<DecalProjector> ();
	
		// Intermediate mesh data. Mesh data is added to that one for a specific projector
		// in order to perform the cutting.
	public var m_DecalsMesh : DecalsMesh;
	public var m_DecalsMeshCutter : DecalsMeshCutter;
	...
	var meshOffset : float = 0.001;
		...
		// the moment.
	public var m_UVRectangleIndex : int = 0;
	...
	// Called by other scripts in order to add a new decal to our dynamic object.

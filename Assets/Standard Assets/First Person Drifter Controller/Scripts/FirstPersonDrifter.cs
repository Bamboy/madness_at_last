...
public class FirstPersonDrifter: MonoBehaviour
{
	...
	public float crouchMovementMultiplier = 0.6f;
	...
	public void SetInputs(float x, float y, bool run, bool jump, bool crouch)
	{ inputX = x; inputY = y; inputJump = jump; inputCrouch = crouch; inputRun = run; }
    ...
    void FixedUpdate() {
        ...
        if (grounded) {
			...
			if (inputCrouch)
				speed = walkSpeed * crouchMovementMultiplier;
            else if (enableRunning)
